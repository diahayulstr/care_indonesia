...
class MasterController extends Controller
{
    ...
    public function update_donor(Request $request, $master) {
        $donor = Donor::findOrFail($master);
        $request -> validate([
            'nama_organisasi'       => 'required',
            'alamat'                => 'required',
            'negara'                => 'required',
            ...
            'komitmen_sdgs'         => 'required|exists:tabel_komitmen_sdgs,id',
            'date'                  => 'required',
            'dokumen_donor'         => 'file|mimes:pdf,doc,docx,xls,xlsx,ppt,pptx,jpg,jpeg,png,gif',
        ]);
        ...
        $donor->save();
        return redirect()->route('donor.master.view_master', ['master' => $donor->id])
