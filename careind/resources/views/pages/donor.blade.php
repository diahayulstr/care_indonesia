                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3 d-flex justify-content-between align-items-center">
                            ...
                            <div>
                                ...
                                <a href="{{ url('master/add') }}" id="btn-addMaster" class="btn btn-outline-primary btn-circle me-2" data-bs-toggle="tooltip" title="Master/Detail Add"><i class="fas fa-plus"></i></a>
                                <a href="{{url('donor/add')}}" id="btn-add-donor" class="btn btn-primary btn-circle me-2" data-bs-toggle="tooltip" title="Add"><i class="fas fa-plus"></i></a>
                            </div>
                        </div>
                        <div class="card-body">
                                            ...
                                            <td class="text-center">
                                                <div class="action-buttons d-flex justify-content-center">
                                                    ...
                                                    <div class="d-inline-block mx-1">
                                                        <a href="{{ url('donor/'.$item->id.'/edit')}}" id="btn-edit-donor" class="btn btn-warning btn-circle" data-bs-toggle="tooltip" title="Edit">
                                                    ...
                                                    <div class="d-inline-block">
                                                        <div class="dropdown">
                                                            ...
                                                            <ul class="dropdown-menu">
                                                                ...
                                                                <li><a id="btn-edit-master" class="dropdown-item" href="{{ url('master/'.$item->id.'/edit') }}">Master/Detail Edit</a></li>
                                                            </ul>
                                                        </div>
                                                    </div>
                                                </div>
