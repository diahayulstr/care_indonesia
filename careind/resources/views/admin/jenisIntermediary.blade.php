                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        <div class="action-buttons d-flex justify-content-center">
                                                            ...
                                                            <form action="{{ url('jenis_intermediary/'.$item->id) }}" method="POST">
                                                                @method('DELETE')
                                                                @csrf
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div class="collapse show" id="collapseCardExample">
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-12">
                                                <form action="{{ url('jenis_intermediary') }}" method="POST" enctype="multipart/form-data">
                                                    @csrf
                                                    ...
                                                    <a href="{{ url('jenis_intermediary') }}" class="btn btn-outline-primary">Cancel</a>
                                                </form>
                                            </div>
                                        </div>
                                    </div>
