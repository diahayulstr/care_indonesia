...
<body id="page-top">
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3 d-flex justify-content-between align-items-center">
                            ...
                            <div>
                                <a href="{{ url('master/' . $donor->id) }}"
                                    class="btn btn-outline-info btn-circle me-2" data-bs-toggle="tooltip"
                        ...
                        <form id="form-edit-master"
                            action="{{ route('master.update_master_add', ['master' => $donor->id]) }}" method="POST"
                            id="form-edit-master" enctype="multipart/form-data">
                            @method('PATCH')
                            @csrf
                            <div class="card-body">
                                <!-- Default Tabs -->
                                                    ...
                                                    @forelse ($narahubung as $narahubungs)
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                @error('items_narahubung.' . $narahubungs->id .
                                                                    '.nama_kontak')
                                                                    <div class="text-danger">{{ $message }}</div>
                                                                @enderror
                                                            </td>
                                                            ...
                                                            {{-- <td>
                                                                <div class="d-inline-block">
                                                                    <a class="btn btn-danger btn-circle delete-btn-komunikasi"
                                                                        ...
                                                                        data-komunikasi-id="{{ $komunikasis->id }}"
                                                                        title="Delete"><i class="fas fa-trash"></i>
                                                                    </a>
                                                                </div>
                                                            </td> --}}
                                                ...
                                                <tbody>
                                                    @forelse ($proposal as $proposals)
                                                        <tr>
                                                            ...
                                                            <td id="group-select2">
                                                                <select
                                                                    class="impact-goals-select form-select form-control"
                                                                    name="items_proposal[{{ $proposals->id }}][impact_goals_id][]"
                                                                    id="impact_goals_id_{{ $proposals->id }}"
                                                                    multiple>
                                                            ...
                                                            <td>
                                                                <select class="form-select form-control"
                                                                    name="items_proposal[{{ $proposals->id }}][status_kemajuan_id]"
                                                            ...
                                                            {{-- <td>
                                                                <div class="d-inline-block">
                                                                    <a class="btn btn-danger btn-circle delete-btn-proposal"
                                                                        ...
                                                                        data-proposal-id="{{ $proposals->id }}"
                                                                        title="Delete"><i class="fas fa-trash"></i>
                                                                    </a>
                                                                </div>
                                                            </td> --}}
                                                        @empty
                                                            <td colspan="14" class="text-center">Tidak ada data...
                                                            </td>
                                                        </tr>
                                                    @endforelse
                                                </tbody>
    ...
    {{-- <form id="deleteFormNarahubung{{ $narahubungs->id }}" action="{{ url('master/' . $narahubungs->id . '/narahubung') }}" method="POST"
        style="display: none;">
        @method('DELETE')
        @csrf
    </form>

    <form id="deleteFormKomunikasi" action="{{ url('master/' . $komunikasis->id . '/komunikasi') }}" method="POST"
        style="display: none;">
        @method('DELETE')
        @csrf
    </form>

    <form id="deleteFormProposal" action="{{ url('master/' . $proposals->id . '/proposal') }}" method="POST"
        style="display: none;">
        @method('DELETE')
        @csrf
    </form> --}}
