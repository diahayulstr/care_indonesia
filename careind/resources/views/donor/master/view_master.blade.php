...
<body id="page-top">
    ...
    <div id="wrapper">
                                    ...
                                    <div class="d-flex justify-content-between align-items-center mb-3">
                                        ...
                                        <div class="action-buttons">
                                            <a href="#" class="btn btn-primary btn-circle me-2" title="Add"
                                                data-bs-toggle="modal" data-bs-target="#form-add-master-narahubung"
                                                id="btn-addmaster-narahubung"
                                                data-id="{{ $donor->id }}">
                                                            ...
                                                            <div class="action-buttons d-flex justify-content-center">
                                                                ...
                                                                <div class="d-inline-block mx-1">
                                                                    <a href="#"
                                                                        ...
                                                                        data-bs-toggle="modal" data-bs-target="#form-edit-master-narahubung" title="Edit"
                                                                        data-narahubung-id = "{{ $item->id }}"
                                    ...
                                    <div class="d-flex justify-content-between align-items-center mb-3">
                                        ...
                                        <div class="action-buttons">
                                            <a href="#" class="btn btn-primary btn-circle me-2" title="Add"
                                                ...
                                                id="btn-addmaster-komunikasi" data-id="{{ $donor->nama_organisasi }}"><i
                                                            ...
                                                            <div class="action-buttons d-flex justify-content-center">
                                                                ...
                                                                <div class="d-inline-block mx-1">
                                                                    <a href="#"
                                                                        ...
                                                                        data-bs-toggle="modal" data-bs-target="#form-edit-master-komunikasi" title="Edit"
                                    ...
                                    <div class="d-flex justify-content-between align-items-center mb-3">
                                        ...
                                        <div class="action-buttons">
                                            <a href="#" class="btn btn-primary btn-circle me-2" title="Add"
                                                ...
                                                id="btn-addmaster-proposal" data-id="{{ $donor->nama_organisasi }}"><i
                                                    class="fas fa-plus"></i></a>
                                        </div>
                                    </div>
                                    <div class="table-responsive">
                                                            ...
                                                            <div class="action-buttons d-flex justify-content-center">
                                                                ...
                                                                <div class="d-inline-block mx-1">
                                                                    <a href="#"
                                                                        ...
                                                                        data-bs-toggle="modal" data-bs-target="#form-edit-master-proposal" title="Edit"
                                                                ...
                                                                <div class="d-inline-block">
                                                                    <form action="{{ url('master_proposal/' . $item->id) }}"
                                                                        method="POST">
                                                                        @method('DELETE')
                                                                        @csrf
                                                                        <button
        ...
        <div class="modal fade" id="form-add-master-narahubung" data-bs-backdrop="static" data-bs-keyboard="false"
            tabindex="-1" aria-labelledby="formAddLabelNarahubung" aria-hidden="true">
            <div class="modal-dialog modal-lg">
                <form id="addmasterFormNarahubung" action="{{ url('master/master_narahubung') }}"
                    method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="modal-content">
                        <div class="modal-header">
                            <h1 class="modal-title fs-5" id="formAddLabelNarahubung">Add Narahubung</h1>
                                ...
                                <div class="col-16">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="donor_id"
                                            id="donor_id-master-narahubung" readonly value="{{ $item->donor_id ?? '' }}">
                                        @error('donor_id')
