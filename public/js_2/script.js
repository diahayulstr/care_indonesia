...
$(document).ready(function () {
    $(document).on("click", "#btn-update-user", function () {
        ...
        // $("#updateForm").attr("action", `/jenis_organisasi/${data_id}`);
        // $("#updateForm").attr("action", `/jenis_penerimaan/${data_id}`);
        // $("#updateForm").attr("action", `/jenjang_komunikasi/${data_id}`);
        // $("#updateForm").attr("action", `/klasifikasi_portfolio/${data_id}`);
        // $("#updateForm").attr("action", `/komitmen_sdgs/${data_id}`);
        // $("#updateForm").attr("action", `/saluran/${data_id}`);
        // $("#updateForm").attr("action", `/saluran_pendanaan/${data_id}`);
        // $("#updateForm").attr("action", `/status/${data_id}`);
        // $("#updateForm").attr("action", `/status_kemajuan/${data_id}`);
        // $("#updateForm").attr("action", `/tindak_lanjut/${data_id}`);
        // $("#updateForm").attr("action", `/tujuan_pendanaan/${data_id}`);
        // $("#updateForm").attr("action", `/user/${data_id}`);
    ...
    // Impact Goals
    $(document).on("click", "#btn-update-impact", function () {
        let data_id = $(this).attr("data-id");
        let data_name = $(this).attr("data-name");
        ...
        $("#updateForm").attr("action", `/impact_goals/${data_id}`);
    });

    // Jenis Intermediary
    $(document).on("click", "#btn-update-jenis-intermediary", function () {
        let data_id = $(this).attr("data-id");
        let data_name = $(this).attr("data-name");
        ...
        $("#updateForm").attr("action", `/jenis_intermediary/${data_id}`);
    });

    // Jenis Organisasi
    $(document).on("click", "#btn-update-jenis-organisasi", function () {
        let data_id = $(this).attr("data-id");
        let data_name = $(this).attr("data-name");
    ...
    // Jenis Penerimaan
    $(document).on("click", "#btn-update-jenis-penerimaan", function () {
        let data_id = $(this).attr("data-id");
        let data_name = $(this).attr("data-name");
    ...
    // Jenjang Komunikasi
    $(document).on("click", "#btn-update-jenjang-komunikasi", function () {
        let data_id = $(this).attr("data-id");
        let data_name = $(this).attr("data-name");
    ...
    $(document).on("click", "#btn-update-klasifikasi-portfolio", function () {
        let data_id = $(this).attr("data-id");
        let data_name = $(this).attr("data-name");
    ...
    // Komitmen SDGs
    $(document).on("click", "#btn-update-komitmen-sdgs", function () {
        let data_id = $(this).attr("data-id");
        let data_name = $(this).attr("data-name");
    ...
    // Saluran
    $(document).on("click", "#btn-update-saluran", function () {
        let data_id = $(this).attr("data-id");
        let data_name = $(this).attr("data-name");
    ...
    // Saluran Pendanaan
    $(document).on("click", "#btn-update-saluran-pendanaan", function () {
        let data_id = $(this).attr("data-id");
        let data_name = $(this).attr("data-name");
    ...
    // Status Kemajuan
    $(document).on("click", "#btn-update-status-kemajuan", function () {
        let data_id = $(this).attr("data-id");
        let data_name = $(this).attr("data-name");
    ...
    // Tindak Lanjut
    $(document).on("click", "#btn-update-tindak-lanjut", function () {
        let data_id = $(this).attr("data-id");
        let data_name = $(this).attr("data-name");
    ...
    // Tujuan Pendanaan
    $(document).on("click", "#btn-update-tujuan-pendanaan", function () {
        let data_id = $(this).attr("data-id");
        let data_name = $(this).attr("data-name");
