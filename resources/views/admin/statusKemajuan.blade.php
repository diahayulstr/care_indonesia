        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <!-- Topbar Search -->
                    <form method="GET" action="{{ url('status_kemajuan/cari') }}"
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Status Kemajuan</h1>
                    </div>
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="card mb-4">
                                ...
                                <div class="card-header">
                                    <h6 class="m-0 font-weight-bold text-danger">View Status Kemajuan</h6>
                                </div>
                                <div class="card-body">
                                        ...
                                        <table class="table table-hover table-bordered">
                                            <thead>
                                                <tr class="text-center fw-bold">
                                                    <th>ID</th>
                                                    <th>Nama Status Kemajuan</th>
                                                    <th>Aksi</th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                @forelse($statusKemajuan as $item)
                                                    <tr>
                                                        <td>{{ $item->id }}</td>
                                                        <td>{{ $item->name }}</td>
                                                        <td class="text-center">
                                                            <div class="action-buttons d-flex justify-content-center">
                                                                <div class="d-inline-block">
                                                                    <a href="#" id="btn-update-status-kemajuan"
                                                                ...
                                                                <div class="d-inline-block mx-1">
                                                                    <form
                                                                        action="{{ url('status_kemajuan/' . $item->id) }}"
                                                                        method="POST">
                                                                        @method('DELETE')
                                                                        @csrf
                                                                        <button
                                ...
                                <div class="card-footer">
                                    {{ $statusKemajuan->links('vendor.pagination.bootstrap-5') }}
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-6">
                            <div class="card shadow mb-4">
                                <a href="#collapseCardExample" class="d-block card-header py-3"
                                    ...
                                    <h6 class="m-0 font-weight-bold text-danger">Add Status Kemajuan</h6>
                                </a>
                                <div class="collapse show" id="collapseCardExample">
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-12">
                                                <form action="{{ url('status_kemajuan') }}" method="POST"
                                                    enctype="multipart/form-data">
                                                    @csrf
                                                    <div class="form-group">
                                                        <label for="name">Nama Status Kemajuan</label>
                                                        <input type="text" placeholder="Nama Status Kemajuan"
    ...
    @if ($statusKemajuan->count() > 0)
        <div class="modal fade" id="form-update" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
            ...
            <div class="modal-dialog">
                <form id="updateForm" action="{{ url('status_kemajuan/' . $item->id) }}" method="POST"
                    enctype="multipart/form-data">
                    @method('PATCH')
                    @csrf
                    <div class="modal-content">
                        <div class="modal-header">
                            <h1 class="modal-title fs-5" id="formUpdateLabel">Update Status Kemajuan</h1>
