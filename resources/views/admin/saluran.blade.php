            ...
            <li class="nav-item active">
                ...
                <div id="collapseTwo" class="collapse show" aria-labelledby="headingTwo"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item active" href="{{ url('saluran') }}">Saluran</a>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <!-- Topbar Search -->
                    <form method="GET" action="{{ url('saluran/cari') }}"
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Saluran</h1>
                    </div>
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="card mb-4">
                                ...
                                <div class="card-header">
                                    <h6 class="m-0 font-weight-bold text-danger">View Saluran</h6>
                                </div>
                                <div class="card-body">
                                                        ...
                                                        <td class="text-center">
                                                            <div class="action-buttons d-flex justify-content-center">
                                                                ...
                                                                <div class="d-inline-block mx-1">
                                                                    <form action="{{ url('saluran/' . $item->id) }}"
                                                                        method="POST">
                                                                        @method('DELETE')
                                                                        @csrf
                                                                        <button
                                ...
                                <div class="card-footer">
                                    {{ $saluran->links('vendor.pagination.bootstrap-5') }}
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-6">
                            <div class="card shadow mb-4">
                                <a href="#collapseCardExample" class="d-block card-header py-3"
                                    ...
                                    <h6 class="m-0 font-weight-bold text-danger">Add Saluran</h6>
                                </a>
                                <div class="collapse show" id="collapseCardExample">
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-12">
                                                <form action="{{ url('saluran') }}" method="POST"
                                                    enctype="multipart/form-data">
                                                    @csrf
                                                    <div class="form-group">
                                                        <label for="name">Nama Saluran</label>
                                                        <input type="text" placeholder="Nama Saluran"
    ...
    @if ($saluran->count() > 0)
        <div class="modal fade" id="form-update" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
            ...
            <div class="modal-dialog">
                <form id="updateForm" action="{{ url('saluran/' . $item->id) }}" method="POST"
                    enctype="multipart/form-data">
                    @method('PATCH')
                    @csrf
                    <div class="modal-content">
                        <div class="modal-header">
                            <h1 class="modal-title fs-5" id="formUpdateLabel">Update Saluran</h1>
