            ...
            <li class="nav-item active">
                ...
                <div id="collapseTwo" class="collapse show" aria-labelledby="headingTwo"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item active" href="{{ url('jenjang_komunikasi') }}">Jenjang Komunikasi</a>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <!-- Topbar Search -->
                    <form method="GET" action="{{ url('jenjang_komunikasi/cari') }}"
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Jenjang Komunikasi</h1>
                    </div>
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="card mb-4">
                                ...
                                <div class="card-header">
                                    <h6 class="m-0 font-weight-bold text-danger">View Jenjang Komunikasi</h6>
                                </div>
                                <div class="card-body">
                                        ...
                                        <table class="table table-hover table-bordered">
                                            <thead>
                                                <tr class="text-center fw-bold">
                                                    <th>ID</th>
                                                    <th>Nama Jenjang Komunikasi </th>
                                                    <th>Aksi</th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                @forelse($jenjangKomunikasi as $item)
                                                    <tr>
                                                        <td>{{ $item->id }}</td>
                                                        <td>{{ $item->name }}</td>
                                                        <td class="text-center">
                                                            <div class="action-buttons d-flex justify-content-center">
                                                                <div class="d-inline-block">
                                                                    <a href="#" id="btn-update-jenjang-komunikasi"
                                                                ...
                                                                <div class="d-inline-block mx-1">
                                                                    <form
                                                                        action="{{ url('jenjang_komunikasi/' . $item->id) }}"
                                                                        method="POST">
                                                                        @method('DELETE')
                                                                        @csrf
                                                                        <button
                                ...
                                <div class="card-footer">
                                    {{ $jenjangKomunikasi->links('vendor.pagination.bootstrap-5') }}
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-6">
                            <div class="card shadow mb-4">
                                <a href="#collapseCardExample" class="d-block card-header py-3"
                                    ...
                                    <h6 class="m-0 font-weight-bold text-danger">Add Jenjang Komunikasi</h6>
                                </a>
                                <div class="collapse show" id="collapseCardExample">
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-12">
                                                <form action="{{ url('jenjang_komunikasi') }}" method="POST"
                                                    enctype="multipart/form-data">
                                                    @csrf
                                                    <div class="form-group">
                                                        <label for="name">Nama Jenjang Komunikasi</label>
                                                        <input type="text" placeholder="Nama Komunikasi"
